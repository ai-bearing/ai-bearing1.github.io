...
\begin{document}
  ...
  \begin{solution}
    ...
    \begin{description}[font=\normalfont\scshape]
      \item[Adjacent:] If two vertices are adjacent, we can find one cycle from the remaining vertices after deletion. There are $(12)(3)/2$ sets of adjacent vertices, for a total of $18$ from this selection.
    ...
    \end{description}
    We find a total of $22$ $6$-cycles in $Q_3$.
  \end{solution}
\end{document}
